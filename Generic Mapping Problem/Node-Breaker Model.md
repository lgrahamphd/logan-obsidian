A network model in which nodes correspond to buses and/or breakers and edges correspond to branches. It is common to store auxiliary data (e.g., electrical properties) with each node and with each branch.
